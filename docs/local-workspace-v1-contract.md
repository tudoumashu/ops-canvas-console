...
opsc ecommerce import-template --workspace ./tmp/ws --remote-template <template_id> --profile <profile_id> --channel <channel_id> --local-executable --material-library <local_anime_ip_library> --json
